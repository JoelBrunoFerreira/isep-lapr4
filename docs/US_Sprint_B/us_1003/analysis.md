...
#### Meeting with the client: ####
    ...
    * A1 - I assume being able to filter by Customer and date would be useful. Also, being able to filter only active ones or all of them seems useful to me.
    ...
    * Q3 - At what moment does a job opening become active? Is it when it's created and has a set of requirements associated with it? Is it when it's linked to an ongoing recruitment process?
    * A3 - The reference to active arises in the context of dates. A job opening whose process has already ended is not active.
...
#### Business rules: ####
    ...
    * Activation of Job Openings:
        - A job opening is considered active while its recruitment process is ongoing.
