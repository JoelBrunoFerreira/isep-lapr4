...
import eapli.base.jobRequirementsManagement.domain.RequirementTitle;
...
public class AddJobRequirementController {
    ...
    public Optional<JobRequirement> addJobRequirement(final String name, final String className) {
        ...
        JobRequirement jobRequirement = new JobRequirement(new RequirementTitle(name), new RequirementClass(className));
